...
public class Installer {
    ...
    public static boolean installToolsToPrefix(AssetManager am) {
        File binDir = new File(Application.getPrefixDir(), "bin");
        if (!install_directory(binDir, false)) return false;

        try {
            String[] tools = am.list("tools/usr/bin");
